            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card state_w1">
                        <div class="body d-flex justify-content-between">
                            <div>
                                <h5><?php studentTicketStat($supervisor['user_id']) ?></h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card state_w1">
                        <div class="body d-flex justify-content-between">
                            <div>                                
                                <h5><?php studentTicketStat($supervisor['user_id'], 0) ?></h5>
                                <span>Pending</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card state_w1">
                        <div class="body d-flex justify-content-between">
                            <div>
                                <h5><?php studentTicketStat($supervisor['user_id'], 1) ?></h5>
                                <span>Responded</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card state_w1">
                        <div class="body d-flex justify-content-between">
                            <div>                            
                                <h5><?php studentTicketStat($supervisor['user_id'], 2) ?></h5>
                                <span>Resolve</span>
                            </div>
