                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="usid" required class="form-control" value="<?php echo $supervisor['user_id'] ?>" placeholder="Username">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                    <input type="hidden" name="us-id" value="<?php echo $supervisor['user_id'] ?>">
                                        <input type="text" name="fn" value="<?php echo $supervisor['first_name'] ?>" required class="form-control" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="ln" value="<?php echo $supervisor['last_name'] ?>" required class="form-control" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="state" value="<?php echo $supervisor['state'] ?>" required class="form-control" placeholder="State">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="email" value="<?php echo $supervisor['email'] ?>" required class="form-control" placeholder="E-mail">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="country" value="<?php echo $supervisor['country'] ?>" required class="form-control" placeholder="Country">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
