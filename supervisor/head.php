...
if (!isset($_SESSION['pa-supervisor'])) {
    header('location: ../sign-in');
}
$stid=$_SESSION['pa-supervisor'];
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="./"><img src="<?php if($supervisor['img'] ==''){
                            echo '../no_image.png';
                        }else echo $supervisor['img'] ?>" alt="User"></a>
                    <div class="detail">
                        <h4><?php if($supervisor['first_name'] ==''){
                            echo $supervisor['user_id'];
                        }else echo $supervisor['first_name'] ?></h4>
                        <small>Supervisor</small>                        
                    </div>
                </div>
            </li>
            <li class="<?php if(isset($isProfile)) echo 'active';?> open"><a href="./"><i class="zmdi zmdi-home"></i><span>Profile</span></a></li>
            <li class="<?php if(isset($isProject)) echo 'active';?> open"><a href="students"><i class="zmdi zmdi-assignment"></i><span>Students</span></a></li>
