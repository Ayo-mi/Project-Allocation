                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <input type="text" required name="subj" class="form-control" placeholder="Enter subject about your problem" />
                                <input type="hidden" id="id" name="id" value="<?php echo $_SESSION['pa-supervisor'] ?>">
                            </div>
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="summernote" id="tic-desc"></div>
