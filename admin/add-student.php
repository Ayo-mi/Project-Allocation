    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form" id="si-up">
                    <div class="header">
                    ...
                    <div class="body">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" class="form-control" id="eml" placeholder="Enter Email">
                            <div class="input-group-append">
                        ...
                        <a class="btn btn-primary btn-block waves-effect waves-light sign-up" type="button" style="color: white;">SIGN UP</a>
