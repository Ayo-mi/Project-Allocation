                        ...
                        <div class="table-responsive">
                            <table class="table table-hover m-b-0 c_table m0b theme-color">
                                ...
                                <tbody>
                                    <?php
                                    try{
                                        $sql = "Select * from custom_projects where status='1';";
