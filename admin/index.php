<?php $isHome=true; require_once 'head.php';?>
<!-- Main Content -->
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon email">
                        <div class="body">
                            <h6>Assigned</h6>
                            <h2><?php echo totalProj()?>% <small class="info">of 100</small></h2>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon domains">
                        <div class="body">
                            <h6>Unassigned</h6>
                            <h2><?php echo totalProj(false)?> <small class="info">of <?php totalProject() ?></small></h2>
                            <small>3% higher than last month</small>
                            <div class="progress">
                                <div class="progress-bar l-blue" role="progressbar" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100" style="width: 38%;"></div>
                            </div>
                        </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong><i class="zmdi zmdi-chart"></i> Tickets</strong> Report</h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?php ticketStatistic() ?></h5>
                                                <span><i class="zmdi zmdi-balance"></i> Total</span>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?php ticketStatistic(1) ?></h5>
                                                <span><i class="zmdi zmdi-mail-reply"></i> Responded</span>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>                            
                                                <h5><?php ticketStatistic(2) ?></h5>
                                                <span><i class="zmdi zmdi-check-circle"></i> Resolve</span>
                                            </div>
