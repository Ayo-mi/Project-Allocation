                            ...
                            <table class="table m-b-0 table-hover c_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="ticket-detail?ID=<?php echo $val['tic_id'] ?>" title="<?php echo $val['subject'] ?>"><?php echo strConti($val['subject'], 75) ?></a></td>                                        
                                        <td><?php echo getStudent($val['stud_id'], 'names') ?></td>
